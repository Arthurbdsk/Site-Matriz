...
export const faqs = [
  ...
  },
  {
    ...
    a: "Estamos na Alameda Madeira, 222, Conjunto 92, no bairro Alphaville, em Barueri, São Paulo. O atendimento é de segunda a sexta das 6h às 22h e aos sábados das 7h às 17h.",
  },
  {
